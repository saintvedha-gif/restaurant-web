...
export const addonGroups: AddonGroup[] = [
  ...
  },
  {
    ...
    addons: [
      ...
      { id: 'extra-salsas', name: 'Extra-salsas', emoji: '🍍', price: 3000 },
      { id: 'cebollita', name: 'Cebollita', emoji: '🧅', price: 3000 },
  ...
  },
  {
    ...
    subtitle: 'Seleccione mínimo 1 opción',
    minSelections: 1,
    maxSelections: 1,
    addons: [
      { id: 'milenial-pequeno', name: 'Pequeño', emoji: '🟡', price: 32000, pricingMode: 'final', maxAdds: 2 },
  ...
  },
  {
    ...
    maxSelections: 1,
    addons: [
      { id: 'maicito37-pequeno', name: 'Pequeño', emoji: '🟡', price: 37000, pricingMode: 'final', maxAdds: 2 },
      { id: 'maicito37-mediano', name: 'Mediano (personal)', emoji: '🟠', price: 41000, pricingMode: 'final', maxAdds: 3 },
      { id: 'maicito37-grande', name: 'Grande (dos personas)', emoji: '🟢', price: 46000, pricingMode: 'final', maxAdds: 3 },
    ],
  },
  {
  ...
  addons: [
    ...
    { id: 'takis', name: 'Takis (en paquetito)', emoji: '🍗', price: 5000 },
    { id: 'chorizo', name: 'Chorizo', emoji: '🐖', price: 7000 },
    { id: 'tocineta', name: 'Tocineta', emoji: '🥓', price: 6000 },
    { id: 'carne', name: 'Carne', emoji: '🥩', price: 8000 },
    { id: 'pollo', name: 'Pollo', emoji: '🍗', price: 6000 },
    { id: 'extraqueso', name: 'Extra Queso Mozzarella', emoji: '🧀', price: 5000 },
    { id: 'doritos', name: 'Doritos', emoji: '🔺', price: 3000 },
    { id: 'chicharroncitos', name: 'Chicharroncitos', emoji: '🐷', price: 7000 },
    { id: 'queso-costeno', name: 'Queso costeño', emoji: '🧂', price: 3000 },
    { id: 'queso-gouda', name: 'Queso gouda', emoji: '🟠', price: 7000 },
  ],
},
  {
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: 63000,
    categoryId: 'salchipapitas',
    image: getImageUrl('Salchipapota.jpg'),
    addons: ['adicionales-salchi'],
  },
  {
    id: 'salchicarnita',
  ...
  },
  {
    ...
    price: 74000,
    categoryId: 'salchipapitas',
    image: getImageUrl('La_Gloriosa_Salchipapa.jpg'),
    imageHero: getImageUrl('La_Gloriosa_Salchipapa.jpg'),
    tags: ['popular'],
  },
  ...
  // MAICITOS
  {
    ...
    imageHero: getImageUrl('Quetzalcoat.jpeg'),
  ...
  },
  {
    ...
    price: 32000,
    categoryId: 'maicitos',
    image: getImageUrl('Milenial.jpeg'),
    imageHero: getImageUrl('Milenial.jpeg'),
    addons: ['tamano-milenial', 'adicionales-maicito'],
    tags: ['popular'],
  },
  {
    id: 'malandro',
